...
class zabbix::proxy (
  ...
  Optional[String] $vaultdbpath                                               = $zabbix::params::proxy_vaultdbpath,
  Optional[String] $vaulttoken                                                = $zabbix::params::proxy_vaulttoken,
  Stdlib::HTTPUrl $vaulturl                                                   = $zabbix::params::proxy_vaulturl,
