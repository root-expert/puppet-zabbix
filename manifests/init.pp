...
class zabbix (
  ...
  Optional[String] $vaultdbpath                                               = $zabbix::params::server_vaultdbpath,
  Optional[String] $vaulttoken                                                = $zabbix::params::server_vaulttoken,
  Stdlib::HTTPUrl $vaulturl                                                   = $zabbix::params::server_vaulturl,
